;(function () {
	...
	var mobileMenuOutsideClick = function() {
	    ...
	    var container = $("#l-offcanvas, .js-l-nav-toggle");
	...
	var offcanvasMenu = function() {
		...
		$('#l-offcanvas').append(clone1);
		var clone2 = $('.menu-2 > ul').clone();
		$('#l-offcanvas').append(clone2);
	...
	var burgerMenu = function() {
		...
		$('body').on('click', '.js-l-nav-toggle', function(event){
			var $this = $(this);
